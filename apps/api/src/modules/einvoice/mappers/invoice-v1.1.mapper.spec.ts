...
describe('UBL 2.1 v1.1 mapper', () => {
  const baseCustomer: Customer = {
    ...
    creditLimit: 0, outstanding: 0, active: true,
  ...
  const invoice: CustomerInvoice = {
    ...
    currency: 'MYR', exchangeRate: 1, subtotal: 100, taxTotal: 8, total: 108,
    paid: 0, balance: 108, status: 'ISSUED', notes: null,
  ...
  it('emits UBL Invoice with header and totals', () => {
    const doc = buildUblInvoice({
      ...
      taxCodes: new Map([['t1', { id: 't1', accountBookId: 'b1', code: 'SVAT-08', name: 'Sales 8%', rate: 0.08, description: null, active: true } as never]]),
      version: '1.1',
    });
