  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        description="Confirmed supplier orders before billing."
        actions={
          <>
      ...
      <DataTable
        ...
        columns={[
          { key: 'number', header: 'Number', render: (o) => <a href={'/purchase/' + o.id} className="font-mono text-xs text-brand-700 hover:underline">{o.number}</a> },
